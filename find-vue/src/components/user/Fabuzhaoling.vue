    ...
    <el-card class="boxcard">
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item label="捡到时间" prop="date">
                <el-col :span="11">
                <el-date-picker type="date" placeholder="选择捡到时间" v-model="form.date" style="width: 100%;"></el-date-picker>
                </el-col>
                
            </el-form-item>
            <el-form-item label="捡到地点" prop="jdddregion">
                <el-select v-model="form.jdddregion" placeholder="请选择捡到地点" style="position:relative;right:130px;">
                    <el-option
                    v-for="item in JdddList"
                    :key="item.id"
                    :label="item.dd"
                    :value="item.dd">
                    </el-option>
            ...
            <el-form-item label="暂存地点" prop="zcdd">
                <el-input v-model="form.zcdd"></el-input>
            </el-form-item>
            <el-upload
                ref="upload"
                :headers="headerObj"
                ...
                <el-button size="small" type="primary" style="position:relative;right:205px;">上传招领物品照片</el-button>
            </el-upload>
            
            <el-form-item >
                <el-button type="primary" @click="onSubmit" style="position:relative;right:100px;">发帖招领</el-button>
    ...
    data() {
      return {
        ...
        rules:{
          ...
          jdddregion: [
            { required: true, message: '请选择捡到地点', trigger: 'change' }
          ],
          date: [
            { type: 'date', required: true, message: '请选择捡到时间', trigger: 'change' }
          ],
          sslxregion: [
        ...
        getJdddList(){
            ...
            .then(successResponse => {
                   if(successResponse.data){
                       this.JdddList=successResponse.data;
                   }
                   else{
                       this.$message('获取捡到地点列表失败');
                   }
                }
            )
        },
